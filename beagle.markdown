...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                ...
                <p>Download ownCloud image for BeagleBone <a class="btn btn-primary" href="https://github.com/syncloud/owncloud-setup/releases/download/v0.1/syncloud-beagle-0.0.3.img.xz">
